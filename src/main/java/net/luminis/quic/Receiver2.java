...
public class Receiver2 {
    ...
    public Receiver2(DatagramSocket socket, Logger log, Consumer<Throwable> abortCallback) {
        this.socket = socket;
        this.log = log;
        ...
        try {
            while (! isClosing) {
                ...
                try {
                    ...
                    RawPacket rawPacket = new RawPacket(receivedPacket, timeReceived, counter++,null,null);
